    ...
    public static class DBAccess
    {
        ...
        public static List<Type> GetEntityTypes()
        {
            return new List<Type>
            {
                /*typeof(Region),
                typeof(Subregion),
                typeof(SubregionVertex),
                typeof(Intersection),
                typeof(Approach),
                typeof(ApproachVertex),
                typeof(StopLine),
                typeof(Lane),
                typeof(Signal),
                typeof(TopologyDate),
        ...
        public static Type ParseTableName(string tableName)
        {
            switch (tableName)
            {
                ...
                case "Subregion":
                    return typeof(Subregion);
                case "SubregionVertex":
                    return typeof(SubregionVertex);
                case "Intersection":
                    return typeof(Intersection);
                case "Approach":
                    return typeof(Approach);
                case "ApproachVertex":
                    return typeof(ApproachVertex);
                case "StopLine":
                    return typeof(StopLine);
                case "Lane":
                    return typeof(Lane);
                case "Signal":
                    return typeof(Signal);
                case "TopologyDate":
                    return typeof(TopologyDate);
                case "RawResponse":
                    return typeof(RawResponse);
                case "HostServer":
                    return typeof(HostServer);*/
            }
        ...
        {
            /*DBTable.Create<Region>(false);
            DBTable.Create<Subregion>(false);
            DBTable.Create<Intersection>(false);
            DBTable.Create<Approach>(false);
            DBTable.Create<Lane>(false);
            DBTable.Create<Signal>(false);
            DBTable.Create<TopologyDate>(false);
            DBTable.Create<RawResponse>(false);
            DBTable.Create<HostServer>(false);
            DBTable.Create<SubregionVertex>(false);
            DBTable.Create<ApproachVertex>(false);
            DBTable.Create<StopLine>(false);*/
        }

        public static void ResetTables()
        {
            /*DBTable.Create<Region>(true);
            DBTable.Create<Subregion>(true);
            DBTable.Create<Intersection>(true);
            DBTable.Create<Approach>(true);
            DBTable.Create<Lane>(true);
            DBTable.Create<Signal>(true);
            DBTable.Create<TopologyDate>(true);
            DBTable.Create<RawResponse>(true);
            DBTable.Create<HostServer>(true);
            DBTable.Create<SubregionVertex>(true);
            DBTable.Create<ApproachVertex>(true);
            DBTable.Create<StopLine>(true);*/
        }
